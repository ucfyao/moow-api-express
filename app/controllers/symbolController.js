...
class SymbolController {
  ...
  async create(req, res) {
    ...
    return ResponseHandler.success(res, symbol, STATUS_TYPE.HTTP_CREATED);
  }
  ...
  async getPrice(req, res) {
    ...
    return ResponseHandler.success(res, symbolData, STATUS_TYPE.HTTP_CREATED);
  }
  ...
  async loadPrice(req, res) {
    ...
    return ResponseHandler.success(res, priceData, STATUS_TYPE.HTTP_CREATED);
  }
}
